...
git clone -b develop git@github.com:kyo-jp/chatty-backend.git # replace this github url with your url of your own project
cd chatty-backend # set your project name
npm install
aws s3 sync s3://chatapp-env-files-gnis/develop . # update with your s3 bucket
unzip env-file.zip
cp .env.develop .env
npm run build
npm run start
